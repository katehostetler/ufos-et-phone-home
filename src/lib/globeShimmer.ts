    ...
    shader.fragmentShader = shader.fragmentShader
      ...
      .replace(
        ...
        #ifdef USE_MAP
        {
          ...
          float __w = smoothstep(0.07, 0.45, __lm); // 0 on dark ocean, ~1 on bright cities (wider net than before)
          ...
          if (__lm > 0.07) {
            ...
            diffuseColor.rgb = mix(diffuseColor.rgb, vec3(__lum), 0.66 * __w);
            diffuseColor.rgb *= mix(1.0, 0.28, __w);
